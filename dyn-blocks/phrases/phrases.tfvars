upload_content = [
  ...
  { content = "A is for Alpha!!! (created via our dynamic block)", file = "/terraform/test3.txt", executable = true },
  { content = "B is for banana!!! (created via our dynamic block)", file = "/terraform/test4.txt", executable = true },
]
